...
/* BENCHMARK_LAYER(LAYER_CUDNN_POOLING_FWD_INT8); */
/* BENCHMARK_LAYER(LAYER_CUDNN_POOLING_FWD_INT32); */
BENCHMARK_LAYER(LAYER_CUDNN_POOLING_FWD_HALF);
BENCHMARK_LAYER(LAYER_CUDNN_POOLING_FWD_FLOAT);
// BENCHMARK_LAYER(LAYER_CUDNN_POOLING_FWD_DOUBLE);
