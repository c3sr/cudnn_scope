...
template <typename T>
static void iLAYER_CUDNN_DROPOUT_BWD_Impl(benchmark::State& state) {
  if (!has_cuda) {
...
template <typename T>
static void LAYER_CUDNN_DROPOUT_BWD_Impl(benchmark::State& state) {
  try {
    iLAYER_CUDNN_DROPOUT_BWD_Impl<T>(state);
...
static void LAYER_CUDNN_DROPOUT_BWD_DOUBLE(benchmark::State& state) {
  LAYER_CUDNN_DROPOUT_BWD_Impl<double>(state);
}

#define CONV_PROBLEMS INFERENCE_SERVER_CONV_PROBLEMS

/* BENCHMARK_CUDNN(LAYER_CUDNN_DROPOUT_BWD_INT8)->INFERENCE_SERVER_CONV_PROBLEMS()->UseManualTime(); */
/* BENCHMARK_CUDNN(LAYER_CUDNN_DROPOUT_BWD_INT32)->INFERENCE_SERVER_CONV_PROBLEMS()->UseManualTime(); */
BENCHMARK_CUDNN(LAYER_CUDNN_DROPOUT_BWD_HALF)->INFERENCE_SERVER_CONV_PROBLEMS()->UseManualTime();
BENCHMARK_CUDNN(LAYER_CUDNN_DROPOUT_BWD_FLOAT)->INFERENCE_SERVER_CONV_PROBLEMS()->UseManualTime();
// BENCHMARK_CUDNN(LAYER_CUDNN_DROPOUT_BWD_DOUBLE)->INFERENCE_SERVER_CONV_PROBLEMS()->UseManualTime();
