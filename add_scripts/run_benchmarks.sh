...
RESULTS_DIR=$(pwd)/results/__add_tensor/${GPU_NAME}

pushd ${SCOPE_TOP_DIR}


CMAKE_OPTIONS="-DADD_TENSOR_ONLY=ON  -DENABLE_CUDNN=ON -DENABLE_CUDNN_DLPERF=ON -DENABLE_COMM=OFF -DENABLE_EXAMPLE=OFF -DCMAKE_BUILD_TYPE=Release -DENABLE_CUDNN_CUPTI=OFF"
